  ...
  return (
    <div id='cta' className='scroll-mt-12 mt-28'>
      <style>{`
            ...
            `}</style>
      <section className="flex flex-col items-center justify-center mx-auto max-md:mx-2 max-md:px-2 max-w-5xl w-full text-center rounded-2xl py-16 bg-indigo-100/10">
        ...
        <div className="flex gap-2">
          <Link to='/app'>
            <button className="px-8 py-2.5 mt-4 text-sm rounded-xs bg-indigo-600 hover:scale-105 transition duration-300 text-white">
              Get Started
            </button>
          </Link>
